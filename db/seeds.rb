...
Comment.create(user: first_user, post: first_post, text: 'This is my first comment')
Comment.create(user: second_user, post: second_post, text: 'This is my first comment')
